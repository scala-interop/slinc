...
class Slinc19(_jitManager: JitManager, linker: Linker)
    extends Slinc:
  protected def jitManager: JitManager = _jitManager

  protected def layoutPlatformSpecific = LayoutI19

  protected def scopePlatformSpecific: ScopeI.PlatformSpecific = Scope19(layoutI, linker)

  protected def transitionsPlatformSpecific: TransitionsI.PlatformSpecific = Transitions19
